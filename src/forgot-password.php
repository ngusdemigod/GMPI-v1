...
<head>
    ...
    <title>Forgot Password - Bright Light Ministry Int'l Partnership Portal</title>
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                try {
                    ...
                    console.error('Forgot password response was not valid JSON:', rawText);
                    throw new Error('Invalid JSON response from forgot-password handler');
                }
                ...
                if (response.ok && result.success) {
                    ...
                    showAlert(result.message || 'An error occurred. Please try again later.', 'error');
                }
            } catch (error) {
